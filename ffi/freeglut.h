...
static const int FREEGLUT = 1;
static const int GLUT_API_VERSION = 4;
static const int FREEGLUT_VERSION_2_0 = 1;
static const int GLUT_XLIB_IMPLEMENTATION = 13;
static const int GLUT_KEY_F1 = 0x0001;
static const int GLUT_KEY_F2 = 0x0002;
static const int GLUT_KEY_F3 = 0x0003;
static const int GLUT_KEY_F4 = 0x0004;
static const int GLUT_KEY_F5 = 0x0005;
static const int GLUT_KEY_F6 = 0x0006;
static const int GLUT_KEY_F7 = 0x0007;
static const int GLUT_KEY_F8 = 0x0008;
static const int GLUT_KEY_F9 = 0x0009;
static const int GLUT_KEY_F10 = 0x000A;
static const int GLUT_KEY_F11 = 0x000B;
static const int GLUT_KEY_F12 = 0x000C;
static const int GLUT_KEY_LEFT = 0x0064;
static const int GLUT_KEY_UP = 0x0065;
static const int GLUT_KEY_RIGHT = 0x0066;
static const int GLUT_KEY_DOWN = 0x0067;
static const int GLUT_KEY_PAGE_UP = 0x0068;
static const int GLUT_KEY_PAGE_DOWN = 0x0069;
static const int GLUT_KEY_HOME = 0x006A;
static const int GLUT_KEY_END = 0x006B;
static const int GLUT_KEY_INSERT = 0x006C;
static const int GLUT_LEFT_BUTTON = 0x0000;
static const int GLUT_MIDDLE_BUTTON = 0x0001;
static const int GLUT_RIGHT_BUTTON = 0x0002;
static const int GLUT_DOWN = 0x0000;
static const int GLUT_UP = 0x0001;
static const int GLUT_LEFT = 0x0000;
static const int GLUT_ENTERED = 0x0001;
static const int GLUT_RGB = 0x0000;
static const int GLUT_RGBA = 0x0000;
static const int GLUT_INDEX = 0x0001;
static const int GLUT_SINGLE = 0x0000;
static const int GLUT_DOUBLE = 0x0002;
static const int GLUT_ACCUM = 0x0004;
static const int GLUT_ALPHA = 0x0008;
static const int GLUT_DEPTH = 0x0010;
static const int GLUT_STENCIL = 0x0020;
static const int GLUT_MULTISAMPLE = 0x0080;
static const int GLUT_STEREO = 0x0100;
static const int GLUT_LUMINANCE = 0x0200;
static const int GLUT_MENU_NOT_IN_USE = 0x0000;
static const int GLUT_MENU_IN_USE = 0x0001;
static const int GLUT_NOT_VISIBLE = 0x0000;
static const int GLUT_VISIBLE = 0x0001;
static const int GLUT_HIDDEN = 0x0000;
static const int GLUT_FULLY_RETAINED = 0x0001;
static const int GLUT_PARTIALLY_RETAINED = 0x0002;
static const int GLUT_FULLY_COVERED = 0x0003;
static const int GLUT_WINDOW_X = 0x0064;
static const int GLUT_WINDOW_Y = 0x0065;
static const int GLUT_WINDOW_WIDTH = 0x0066;
static const int GLUT_WINDOW_HEIGHT = 0x0067;
static const int GLUT_WINDOW_BUFFER_SIZE = 0x0068;
static const int GLUT_WINDOW_STENCIL_SIZE = 0x0069;
static const int GLUT_WINDOW_DEPTH_SIZE = 0x006A;
static const int GLUT_WINDOW_RED_SIZE = 0x006B;
static const int GLUT_WINDOW_GREEN_SIZE = 0x006C;
static const int GLUT_WINDOW_BLUE_SIZE = 0x006D;
static const int GLUT_WINDOW_ALPHA_SIZE = 0x006E;
static const int GLUT_WINDOW_ACCUM_RED_SIZE = 0x006F;
static const int GLUT_WINDOW_ACCUM_GREEN_SIZE = 0x0070;
static const int GLUT_WINDOW_ACCUM_BLUE_SIZE = 0x0071;
static const int GLUT_WINDOW_ACCUM_ALPHA_SIZE = 0x0072;
static const int GLUT_WINDOW_DOUBLEBUFFER = 0x0073;
static const int GLUT_WINDOW_RGBA = 0x0074;
static const int GLUT_WINDOW_PARENT = 0x0075;
static const int GLUT_WINDOW_NUM_CHILDREN = 0x0076;
static const int GLUT_WINDOW_COLORMAP_SIZE = 0x0077;
static const int GLUT_WINDOW_NUM_SAMPLES = 0x0078;
static const int GLUT_WINDOW_STEREO = 0x0079;
static const int GLUT_WINDOW_CURSOR = 0x007A;
static const int GLUT_SCREEN_WIDTH = 0x00C8;
static const int GLUT_SCREEN_HEIGHT = 0x00C9;
static const int GLUT_SCREEN_WIDTH_MM = 0x00CA;
static const int GLUT_SCREEN_HEIGHT_MM = 0x00CB;
static const int GLUT_MENU_NUM_ITEMS = 0x012C;
static const int GLUT_DISPLAY_MODE_POSSIBLE = 0x0190;
static const int GLUT_INIT_WINDOW_X = 0x01F4;
static const int GLUT_INIT_WINDOW_Y = 0x01F5;
static const int GLUT_INIT_WINDOW_WIDTH = 0x01F6;
static const int GLUT_INIT_WINDOW_HEIGHT = 0x01F7;
static const int GLUT_INIT_DISPLAY_MODE = 0x01F8;
static const int GLUT_ELAPSED_TIME = 0x02BC;
static const int GLUT_WINDOW_FORMAT_ID = 0x007B;
static const int GLUT_HAS_KEYBOARD = 0x0258;
static const int GLUT_HAS_MOUSE = 0x0259;
static const int GLUT_HAS_SPACEBALL = 0x025A;
static const int GLUT_HAS_DIAL_AND_BUTTON_BOX = 0x025B;
static const int GLUT_HAS_TABLET = 0x025C;
static const int GLUT_NUM_MOUSE_BUTTONS = 0x025D;
static const int GLUT_NUM_SPACEBALL_BUTTONS = 0x025E;
static const int GLUT_NUM_BUTTON_BOX_BUTTONS = 0x025F;
static const int GLUT_NUM_DIALS = 0x0260;
static const int GLUT_NUM_TABLET_BUTTONS = 0x0261;
static const int GLUT_DEVICE_IGNORE_KEY_REPEAT = 0x0262;
static const int GLUT_DEVICE_KEY_REPEAT = 0x0263;
static const int GLUT_HAS_JOYSTICK = 0x0264;
static const int GLUT_OWNS_JOYSTICK = 0x0265;
static const int GLUT_JOYSTICK_BUTTONS = 0x0266;
static const int GLUT_JOYSTICK_AXES = 0x0267;
static const int GLUT_JOYSTICK_POLL_RATE = 0x0268;
static const int GLUT_OVERLAY_POSSIBLE = 0x0320;
static const int GLUT_LAYER_IN_USE = 0x0321;
static const int GLUT_HAS_OVERLAY = 0x0322;
static const int GLUT_TRANSPARENT_INDEX = 0x0323;
static const int GLUT_NORMAL_DAMAGED = 0x0324;
static const int GLUT_OVERLAY_DAMAGED = 0x0325;
static const int GLUT_VIDEO_RESIZE_POSSIBLE = 0x0384;
static const int GLUT_VIDEO_RESIZE_IN_USE = 0x0385;
static const int GLUT_VIDEO_RESIZE_X_DELTA = 0x0386;
static const int GLUT_VIDEO_RESIZE_Y_DELTA = 0x0387;
static const int GLUT_VIDEO_RESIZE_WIDTH_DELTA = 0x0388;
static const int GLUT_VIDEO_RESIZE_HEIGHT_DELTA = 0x0389;
static const int GLUT_VIDEO_RESIZE_X = 0x038A;
static const int GLUT_VIDEO_RESIZE_Y = 0x038B;
static const int GLUT_VIDEO_RESIZE_WIDTH = 0x038C;
static const int GLUT_VIDEO_RESIZE_HEIGHT = 0x038D;
static const int GLUT_NORMAL = 0x0000;
static const int GLUT_OVERLAY = 0x0001;
static const int GLUT_ACTIVE_SHIFT = 0x0001;
static const int GLUT_ACTIVE_CTRL = 0x0002;
static const int GLUT_ACTIVE_ALT = 0x0004;
static const int GLUT_CURSOR_RIGHT_ARROW = 0x0000;
static const int GLUT_CURSOR_LEFT_ARROW = 0x0001;
static const int GLUT_CURSOR_INFO = 0x0002;
static const int GLUT_CURSOR_DESTROY = 0x0003;
static const int GLUT_CURSOR_HELP = 0x0004;
static const int GLUT_CURSOR_CYCLE = 0x0005;
static const int GLUT_CURSOR_SPRAY = 0x0006;
static const int GLUT_CURSOR_WAIT = 0x0007;
static const int GLUT_CURSOR_TEXT = 0x0008;
static const int GLUT_CURSOR_CROSSHAIR = 0x0009;
static const int GLUT_CURSOR_UP_DOWN = 0x000A;
static const int GLUT_CURSOR_LEFT_RIGHT = 0x000B;
static const int GLUT_CURSOR_TOP_SIDE = 0x000C;
static const int GLUT_CURSOR_BOTTOM_SIDE = 0x000D;
static const int GLUT_CURSOR_LEFT_SIDE = 0x000E;
static const int GLUT_CURSOR_RIGHT_SIDE = 0x000F;
static const int GLUT_CURSOR_TOP_LEFT_CORNER = 0x0010;
static const int GLUT_CURSOR_TOP_RIGHT_CORNER = 0x0011;
static const int GLUT_CURSOR_BOTTOM_RIGHT_CORNER = 0x0012;
static const int GLUT_CURSOR_BOTTOM_LEFT_CORNER = 0x0013;
static const int GLUT_CURSOR_INHERIT = 0x0064;
static const int GLUT_CURSOR_NONE = 0x0065;
static const int GLUT_CURSOR_FULL_CROSSHAIR = 0x0066;
static const int GLUT_RED = 0x0000;
static const int GLUT_GREEN = 0x0001;
static const int GLUT_BLUE = 0x0002;
static const int GLUT_KEY_REPEAT_OFF = 0x0000;
static const int GLUT_KEY_REPEAT_ON = 0x0001;
static const int GLUT_KEY_REPEAT_DEFAULT = 0x0002;
static const int GLUT_JOYSTICK_BUTTON_A = 0x0001;
static const int GLUT_JOYSTICK_BUTTON_B = 0x0002;
static const int GLUT_JOYSTICK_BUTTON_C = 0x0004;
static const int GLUT_JOYSTICK_BUTTON_D = 0x0008;
static const int GLUT_GAME_MODE_ACTIVE = 0x0000;
static const int GLUT_GAME_MODE_POSSIBLE = 0x0001;
static const int GLUT_GAME_MODE_WIDTH = 0x0002;
static const int GLUT_GAME_MODE_HEIGHT = 0x0003;
static const int GLUT_GAME_MODE_PIXEL_DEPTH = 0x0004;
static const int GLUT_GAME_MODE_REFRESH_RATE = 0x0005;
static const int GLUT_GAME_MODE_DISPLAY_CHANGED = 0x0006;

static const int GLUT_KEY_NUM_LOCK = 0x006D;
static const int GLUT_KEY_BEGIN = 0x006E;
static const int GLUT_KEY_DELETE = 0x006F;
static const int GLUT_ACTION_EXIT = 0;
static const int GLUT_ACTION_GLUTMAINLOOP_RETURNS = 1;
static const int GLUT_ACTION_CONTINUE_EXECUTION = 2;
static const int GLUT_CREATE_NEW_CONTEXT = 0;
static const int GLUT_USE_CURRENT_CONTEXT = 1;
static const int GLUT_FORCE_INDIRECT_CONTEXT = 0;
static const int GLUT_ALLOW_DIRECT_CONTEXT = 1;
static const int GLUT_TRY_DIRECT_CONTEXT = 2;
static const int GLUT_FORCE_DIRECT_CONTEXT = 3;
static const int GLUT_INIT_STATE = 0x007C;
static const int GLUT_ACTION_ON_WINDOW_CLOSE = 0x01F9;
static const int GLUT_WINDOW_BORDER_WIDTH = 0x01FA;
static const int GLUT_WINDOW_HEADER_HEIGHT = 0x01FB;
static const int GLUT_VERSION = 0x01FC;
static const int GLUT_RENDERING_CONTEXT = 0x01FD;
static const int GLUT_DIRECT_RENDERING = 0x01FE;
static const int GLUT_FULL_SCREEN = 0x01FF;
static const int GLUT_AUX = 0x1000;
static const int GLUT_AUX1 = 0x1000;
static const int GLUT_AUX2 = 0x2000;
static const int GLUT_AUX3 = 0x4000;
static const int GLUT_AUX4 = 0x8000;
static const int GLUT_INIT_MAJOR_VERSION = 0x0200;
static const int GLUT_INIT_MINOR_VERSION = 0x0201;
static const int GLUT_INIT_FLAGS = 0x0202;
static const int GLUT_INIT_PROFILE = 0x0203;
static const int GLUT_DEBUG = 0x0001;
static const int GLUT_FORWARD_COMPATIBLE = 0x0002;
static const int GLUT_CORE_PROFILE = 0x0001;
static const int GLUT_COMPATIBILITY_PROFILE = 0x0002;
static const int GLUT_CAPTIONLESS = 0x0400;
static const int GLUT_BORDERLESS = 0x0800;
static const int GLUT_SRGB = 0x1000;
